<style>
    .main-sidebar {
        background: linear-gradient(to bottom, #2ab4d6, #2ab4d6);
    }
</style>
...
<div class="main-sidebar sidebar-style-2">
	<aside id="sidebar-wrapper">
		<div class="sidebar-brand">
			<a href="index.html"> <img alt="image" src="/assets/images/logo/logo_guideon.png" style="width: 90px; height: 90px" class="header-logo" />
				{{-- <span class="logo-name">{{ Auth::user()->nama }}</span> --}}
			</a>
		</div>
		<ul class="sidebar-menu">
			<li class="menu-header" style="color: #ffffff">main</li>

			@auth('admin')
			<li class="dropdown{{ request()->routeIs('dashboard.admin') ? ' active' : '' }}">
				<a href="{{ route('dashboard.admin') }}" class="nav-link"><i
						data-feather="monitor"></i><span class="text-black">Dashboard</span></a>
			</li>
				</li>
			@elseauth('dosen')
			...
			@elseif(Auth::guard('dosen')->check())
				<li class="menu-header" style="color: #ffffff">Manajemen</li>
			...
			<li class="menu-header" style="color: #ffffff">Action</li>
